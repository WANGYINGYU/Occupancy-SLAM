...
```text
<img src="https://raw.githubusercontent.com/WANGYINGYU/Occupancy-SLAM/master/images/High_Frequency.png" alt="Comparisons using high-frequency scans" width="600">
```
